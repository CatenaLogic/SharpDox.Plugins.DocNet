// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DocNetExporter.cs" company="CatenaLogic">
...
namespace SharpDox.Plugins.DocNet
{
    ...
    public class DocNetExporter : IExporter
    {
        private readonly DocNetConfig _config;

        private readonly ILocalController _localController;
        private readonly DocNetStrings _strings;

        private double _docCount;
        private double _docIndex;

        public DocNetExporter(ILocalController localController, DocNetConfig config)
        {
            _localController = localController;
            _strings = localController.GetLocalStrings<DocNetStrings>();
            _config = config;
        }
